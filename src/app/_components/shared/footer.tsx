  ...
  return (
    <div className="footer  bg-zinc-300 py-5 mt-4 ">
      <div className=" md:flex justify-around ">
        <div className="brand-info pt-4 md:w-30/100  text-center ">
        ...
        <div className="help-section pt-4  text-center ">
        ...
        <div className="contactus pt-4   text-center ">
          <h1 className="text-4xl mb-3 ">contact us</h1>
          <div className="icons flex gap-5 justify-center">
            <Facebook />
            <Instagram />
            <Twitter />
          </div>
